...
?>
	...
	<?php elseif ( !is_singular() && $nav = get_posts_nav_link( array( 'sep' => '', 'prelabel' => '<span class="previous">' . __( '&laquo; 上一页', 'hybrid' ) . '</span>', 'nxtlabel' => '<span class="next">' . __( '下一页 &raquo;', 'hybrid' ) . '</span>' ) ) ) : ?>
